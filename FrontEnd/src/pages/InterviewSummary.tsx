...
export default function InterviewSummary(): JSX.Element {
    ...
    function buildWidgetContext(currentQuestion: AgentQuestion | null) {
        ...
        const fullSystemPrompt = `
            ...
            2) When the conversation is created by the widget/runtime, you MUST call the tool named "register_conversation" exactly once before you ask any interview questions. 
            Call the tool with a single POST body JSON:
            {
            ...
            Call the tool when system__conversation_id becomes available. Wait for the tool call to complete and for the server to respond with success. Do not speak while the tool call is in progress.
